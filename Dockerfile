...
ARG miniconda_sha256="5dc619babc1d19d6688617966251a38d245cb93d69066ccde9a013e1ebb5bf18"
...
RUN echo "$LOG_TAG Download Zeppelin binary" && \
    ...
    tar --strip-components=1 -zxf  /tmp/zeppelin-${Z_VERSION}-bin-all.tgz -C ${ZEPPELIN_HOME} && \
